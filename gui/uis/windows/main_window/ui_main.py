...
class UI_MainWindow(object):
    def setup_ui(self, parent):
        ...
        self.left_menu = PyLeftMenu(
            ...
            dark_three=self.themes['app_color']['pink'],
        ...
        self.title_bar = PyTitleBar(
            ...
            btn_bg_color_hover=self.themes["app_color"]["pink"],
        ...
        self.credits_frame.setMinimumHeight(40)
        self.credits_frame.setMaximumHeight(40)
        ...
        self.credits = PyCredits(
            ...
            text_description_color=self.themes["app_color"]["pink"],
            color=self.themes["app_color"]["text_description"],
            selection_color=self.themes['app_color']['pink'],
            bg_color=self.themes["app_color"]["bg_two"],
            bg_color_active=self.themes["app_color"]["bg_two"],
            context_color=self.themes["app_color"]["pink"]
        )
        ...
        custom_scrollbar_style = style_scrollbar.format(
            ...
            _bg_color_pressed=self.themes["app_color"]["pink"]
        )
