...
class Ui_LeftColumn(object):
    def setupUi(self, LeftColumn):
        ...
        self.verticalLayout.setObjectName(u"page_my_album_grid_layout")
        ...
        self.page_my_album_grid_layout.addWidget(self.btn_1_widget)
        ...
        self.page_my_album_grid_layout.addWidget(self.btn_2_widget)
        ...
        self.page_my_album_grid_layout.addWidget(self.btn_3_widget)
        """
        font = QFont()
        ...
        self.page_my_album_grid_layout.addWidget(self.label_1)
        """
